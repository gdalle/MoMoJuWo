...
Quarto provides a Markdown variant with the `.qmd` extension.
Quarto markdown files, like standard Markdown files, also integrate with editors such as VSCode.
...
Additionally, Quarto markdown files give users control over output and styling via the YAML header at the top of the `.qmd` file.
